...
base_path = '/shared_ssd_storage/kittechen/Maggie'
...
def get_target_dataloader(args, clean=True, adv=False):
    if args.adapt_target_method =='card':
        args.is_sample = True
        if args.target_dataset == 'cifar10':
            target_trainset, target_valset, target_testset = get_card_cifar10_dataloaders_sample(args=args,k=args.nce_k)
            return target_trainset, target_valset, target_testset
        elif args.target_dataset == 'cifar100':
            target_trainset, target_valset, target_testset = get_card_cifar100_dataloaders_sample(args=args,k=args.nce_k)
            return target_trainset, target_valset, target_testset
    else:
